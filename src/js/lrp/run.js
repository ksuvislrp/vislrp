...
function runScript()
{
    ...
    if (!imagePath) {
        ...
        childProcess = ChildProcess.spawn('python', ['./src/lrp_pytorch/pytorch_lrp.py', ['-i' + inputImage.toString()], ['-c' + config], ['-l' + "True"], ['-t' + targetClass], ['-s' + '20'], ['-n' + testNode], ['-m' + "True"]], {detached: true});
